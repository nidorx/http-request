...
import com.github.nidorx.http.gson.internal.JavaVersion;
import com.github.nidorx.http.gson.internal.PreJava9DateFormatProvider;
import com.github.nidorx.http.gson.internal.bind.util.ISO8601Utils;
...
final class DefaultDateTypeAdapter extends TypeAdapter<Date> {
  ...
  DefaultDateTypeAdapter(Class<? extends Date> dateType) {
    ...
    if (com.github.nidorx.http.gson.internal.JavaVersion.isJava9OrLater()) {
      dateFormats.add(com.github.nidorx.http.gson.internal.PreJava9DateFormatProvider.getUSDateTimeFormat(DateFormat.DEFAULT, DateFormat.DEFAULT));
    }
  }
  ...
  DefaultDateTypeAdapter(Class<? extends Date> dateType, int style) {
    ...
    if (com.github.nidorx.http.gson.internal.JavaVersion.isJava9OrLater()) {
      dateFormats.add(com.github.nidorx.http.gson.internal.PreJava9DateFormatProvider.getUSDateFormat(style));
    }
  }
