...
public abstract class ReflectionAccessor {
  ...
  private static final ReflectionAccessor instance = JavaVersion.getMajorJavaVersion() < 9 ? new com.github.nidorx.http.gson.internal.reflect.PreJava9ReflectionAccessor() : new UnsafeReflectionAccessor();
